...
def read(data):
	version, dependency_list_size, unknown08_size, unknown0C, \
	...
	cursor = 32 + section_count*20 + unknown08_size + dependency_list_size
	cursor = (cursor+15) & ~15
	...
	for i, (payloadSize, typeid, unknown05, unknown06, reloc_size_and_flags, s_id, language) in \
		...
		sec.index = i
		sec.typeid = typeid
		sec.subtypeid = (reloc_size_and_flags >> 1) & 0x7b
